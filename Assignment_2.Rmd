...
```{r smiles}
  ...
  fraction_test <- floor(0.3 * nrow(data_set))
  ...
  sample_test <- sample(seq_len(nrow(data_set)), size = fraction)
  # make a training set and a test set using the defined sample
  train <- data_set[-sample_test,]     # set the training set (70%)
  test  <- data_set[sample_test,]      # set the test set     (30%)
```
