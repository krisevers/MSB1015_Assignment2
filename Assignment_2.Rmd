...
```{r error}
  ...
  plot(error, main = 'figure 2: error', xlab = '#components', ylab = 'RMSE (K)')
```
...
```{r}
  # 
  plot(test$alkanes.bp, predict_bp[,,3], xlim=c(300,1000), ylim=c(300,1000), main = "figure 3: predicted vs measured boiling points", cex.main = 0.8, xlab = "measured boiling points (K)", ylab = "predicted boiling points (K)")
